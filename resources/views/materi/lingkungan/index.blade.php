              ...
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <iframe width="300" height="315" src="{{ $data[$i]->link }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div class="col-12 text-center">
                        <h6>Materi</h6><br>
                    </div>
                ...
                <div class="card-footer">
                  @if($data[$i]->jawaban->isEmpty())
                  <div class="text-right">
                    <a href="{{ url('/soal/video/lingkungan/') }}/{{ $data[$i]->id }}" class="btn btn-sm btn-primary">
                      <i class="fa fa-edit"></i> Pilih Soal
                    </a>
                  </div>
                  @else
                  <div class="text-right">
                    <a href="{{ url('/jawaban/video/lingkungan/') }}/{{ $data[$i]->id }}/{{ $data[$i]->jawaban[0]->user_id }}" class="btn btn-sm btn-primary">
                      <i class="fa fa-edit"></i> Lihat Jawabanmu
                    </a>
                  </div>
                  @endif
